...
data class Variations(
    ...
    @SerializedName("groupBuyProductDiscount") var groupBuyProductDiscount: GroupBuyProductDiscount? = GroupBuyProductDiscount(),
    ...
    @SerializedName("groupBuyPrice") var groupBuyPrice: GroupBuyPrice? = GroupBuyPrice(),
    ...
    @SerializedName("pointAmount") var pointAmount: String? = null,
